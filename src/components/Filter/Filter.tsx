  ...
  return (
    <div className="flex flex-col sm:flex-row gap-10">
        ...
        {categories.map((category: Category) => (
          <button
            ...
            className={`inline-flex items-center px-4 py-2 font-medium rounded-md text-gray-900 hover:bg-gray-50 border-2 ring-1 w-48 ${
              selectedCategory.name === category.name ? "border-blue-500 ring-blue-500" : "border-transparent ring-transparent"
            }`}
      ...
      <div className="sm:hidden">
        <Dropdown categories={categories} selectedCategory={selectedCategory} onChange={setSelectedCategory} />
      </div>
      <div>
        <IconList icons={icons} selectedCategory={selectedCategory} handleIconClick={handleIconClick} search={search} />
      </div>
